...
import com.dininghall.dhall.framework.entity.ConstantsEnum;
...
import com.dininghall.dhall.framework.until.MD5Util;
import com.dininghall.dhall.framework.until.PageUtil;
import com.dininghall.dhall.system.model.User;
import com.dininghall.dhall.system.service.UserService;
...
public class UserController {
    ...
    public Response register(@RequestBody JSONObject data) {
        ...
        user.setPhone(phone);
        user.setEmail(email);
        user.setRoleName(PermissionConstants.USER_ROLE_MANAGER);
        //4、调用Service，新增用户
        try {
